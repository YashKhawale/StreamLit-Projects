...
st.set_page_config(page_title="Cryptocurrency Price Analysis Web App", layout="wide")

st.title("⚠️This project is under development⚠️")
st.title("Cryptocurrency Price Analysis Web App")
st.markdown("""
...
col1 = st.sidebar
col2, col3 = st.columns((2,1))# This app is for educational purpose only. Insights gained is not financial advice. Use at your own risk!
import streamlit as st
from PIL import Image
import pandas as pd
import base64
...
def load_data():
    ...
    initial_state_raw = coin_data['props']['initialState']
...
if percent_timeframe == '7d':
    ...
    if not df_change.empty:
        ...
        print("df_change is empty. Skipping plot.")
...
# Sidebar - Currency price unit
currency_price_unit = col1.selectbox('Select currency for price', ('USD', 'BTC', 'ETH'), key='currency_price_selectbox_1')
...
def load_data():
    ...
    for i in listings:
      ...
      percent_change_1h.append(i['quotes'][currency_price_unit]['percent_change_1h'])
      percent_change_24h.append(i['quotes'][currency_price_unit]['percent_change_24h'])
      percent_change_7d.append(i['quotes'][currency_price_unit]['percent_change_7d'])
      market_cap.append(i['quotes'][currency_price_unit]['market_cap'])
      volume_24h.append(i['quotes'][currency_price_unit]['volume_24h'])
